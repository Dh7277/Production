...
Route::group(['prefix' => 'admin'], function(){
    ...
    //     Route::get('/categories/{category}/destroy', [CategoryController::class, 'destroyPage'])->name('categories.destroyPage');
    //     Route::put('/category/{category}', [CategoryController::class, 'destroy'])->name('categories.destroy');
